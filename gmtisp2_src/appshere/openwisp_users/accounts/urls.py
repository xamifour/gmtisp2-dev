...
urlpatterns = [
    ...
    # path('signup/', views.SignupView.as_view(form_class=CustomSignupForm), name='account_signup'),
    # path('', views.LoginView.as_view(form_class=CustomLoginForm), name='account_login'),
